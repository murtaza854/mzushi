...
const productCategoryObj = {
    apiTable: `${api}/product-category/table-data`,
    deleteApi: [`${api}/product-category/get-by-ids`, `${api}/product-category/delete`],
    ...
    Form: function (id, classes) {
        ...
        const [descriptionState, setDescriptionState] = useState({ name: '', helperText: 'SEO description Ex. This product category is...' });
        ...
        function changeNameState(event) {
            ...
            let obj = editObjCheck(productCategoriesArray, value, editObj);
        ...
        const onSubmit = async e => {
            e.preventDefault();
            if (queryID === '') {
                await fetch(`${api}/product-category/add`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'Cache-Control': 'no-store'
            ...
            if (pressedBtn === 1) {
                ...
                setDescriptionState({ name: '', helperText: 'Enter description Ex. This product category is...' });
                setCategoryState({ name: '', obj: undefined, helperText: 'Enter name Ex. Electronic', error: false });
                queryID = '';
                history.push('/admin/product-category/add');
            }
        };
...
export default productCategoryObj;